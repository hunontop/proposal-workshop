...
B = "".join([
    ...
    step(3, "이 화면이 나오면 준비 끝입니다",
         ...
         '<p>메뉴 구성이 VS Code와 <b>거의 같습니다</b> — 과정에서 “왼쪽 탐색기”, “터미널을 여세요” 같은 안내가 그대로 통합니다.</p>',
...
<header>
  <div class="eyebrow">시작 전 준비</div>
  <h1>에이전트 하나만 설치해 오세요</h1>
  <p class="lead">AI 기초부터 업무 자동화까지 · 반복업무 1/10로 줄이기</p>
</header>

<div class="note">
  <b>준비물은 이것 하나뿐입니다.</b><br>
  나머지 도구는 <b>과정 중에 함께 설치</b>합니다. 직접 설치해 보는 것이 내용의 일부라서, 미리 하지 않으셔도 됩니다.<br>
  다만 <b>에이전트만은 먼저</b> 준비해 주세요. 이것 하나가 서 있어야 나머지가 이어집니다.
</div>
...
<div class="note">
  둘 중 <b>어느 쪽이든 과정을 따라오는 데 문제없습니다.</b>

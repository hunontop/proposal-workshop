...
SESSIONS = [
    ...
    ("7편", "공정 입구 · 선택과 브리프 · 39~44장", [
        ...
        ("수집 결과 묶음 (zip)", None,
         "42장 수집이 오래 걸리거나 막힌 분을 위한 예비입니다. 공고 10건의 목록·상세를 분류 전 상태로 묶었습니다 — 받아서 풀면 분류부터 이어갈 수 있습니다.", "soon"),
    ...
    ("8편", "관문 · AI를 멈춰 세우는 자리 · 45~46장", [
        ("실습 프롬프트 — 관문까지 돌리기", "files/프롬프트_관문까지_돌리기.md",
         "45·46장. 관문에서 멈추고, 부탁이 아니라 체크로 여는 것을 손으로 확인합니다. 방향이 굳을 때까지 돌립니다.", "ready"),
    ]),
    ("9편", "도식 · 말로 먼저 그린다 · 47~50장", [
        ("실습 프롬프트 — 스토리라인에서 한 장", "files/프롬프트_스토리라인_한장.md",
         "47장. 도식으로 넘어가기 전에 방향을 굳히고, 그림으로 그릴 한 장을 꺼냅니다. napkin에 붙여넣을 글이 여기서 나옵니다.", "ready"),
    ...
    ("10편", "디자인과 이미지 프롬프트 · 51~54장", [
        ...
        ("실습 프롬프트 — 이미지를 자동으로 (선택)", "files/프롬프트_codex_연결.md",
         "52장의 「길 A」입니다. 연결하지 않아도 과정은 끝까지 갑니다 — 해 보고 싶을 때만. 수동으로 만든 장은 그대로 두고 빈 자리만 채웁니다.", "ready"),
    ...
    ("부록", "과정이 끝난 뒤", [
        ("실습 프롬프트 — 도구 업데이트 확인", "files/프롬프트_도구_업데이트.md",
         "도구는 과정이 끝난 뒤에도 고쳐집니다. 내 사본이 언제 것인지 확인하고 갱신하는 한마디 — 정기적으로 할 일은 아니고, 오래 안 쓰다 다시 꺼낼 때나 안 되는 이유를 모를 때 씁니다.", "ready"),
    ]),
]

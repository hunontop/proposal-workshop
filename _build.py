...
SESSIONS = [
    ...
    ("S1~S3", "이해·질문 / 문서·조사 / 덱·첫걸음", [
        ...
        #   파일(files/5단계_지도.md)은 남겨 뒀다. 다시 안내할 자리가 생기면 이 줄을 되살린다.
        ("첫 실습 프롬프트 — 공고 조사", "files/프롬프트_공고조사_첫실습.md",
         "과정에서 처음 직접 시켜 보는 실습입니다. 공고를 찾는 문장과 첨부를 열어 보라는 문장 둘을 복사해서 바로 붙여넣으세요.", "ready"),
        ("프롬프트 4요소 카드", "files/프롬프트_4요소_카드.md",
         "맥락·역할·예시·제약 한 장 요약 + 빈칸 양식. 같은 요청을 한 줄로 한 번, 4요소로 한 번 보내는 비포/애프터 실습이 들어 있습니다.", "ready"),
        ("경로 · 작업 폴더 · 터미널", "files/경로_작업폴더_터미널.md",
         "무너지는 곳은 코드가 아니라 '그 파일이 어디 갔지'입니다. 개념 셋과 자리 옮기기 실습, 막혔을 때 되묻는 세 문장.", "ready"),
        ("승인 판단 카드", "files/승인판단_카드.md",
         "승인 창은 여러분의 정지 버튼입니다. 멈출 신호 셋(삭제·전부/전체·설정 변경)과 빨간 글씨를 붙여넣는 법.", "ready"),
    ]),
    ("S4", "설치·시운전", [
        ("설치 확인 한마디", "files/설치확인_한마디.md",
         "설치가 끝나면 에이전트에게 '잘 깔렸는지 확인해줘' 한마디로 점검합니다. 막혔을 때 붙여넣는 문장까지 복사해서 쓰면 됩니다.", "ready"),
    ]),
    ("S5", "선택·브리프", [
    ...
    ("S6", "관문·도식", [
        ("도식 5항목 판정표", "files/도식_5항목_판정표.md",
         "도식 후보를 순서·위계·누락·산출물 분리·밀도로 판정하는 표. 세 동사로 묻는 법과 napkin 주의 두 가지도 함께.", "ready"),
    ]),
    ("S7", "디자인·이미지", [
    ...
    ("S8", "승인·마무리", [
        ("스킬 3줄 양식", "files/스킬_3줄_양식.md",
         "이름·언제 쓰나·순서 3줄. 새 대화에서 이름만 불러 같은 결과가 나오는지까지가 완료입니다.", "ready"),
        ("산출물 자기점검", "files/산출물_자기점검.md",
         "편마다 손에 남아야 하는 것 11칸. 제출하는 곳은 없습니다 — 비어 있는 칸을 스스로 찾는 목록입니다.", "ready"),
    ]),
]

...
SESSIONS = [
    ...
    ("6편", "설치와 시운전 · 33~38장", [
        ("실습 프롬프트 — 도구 두 개 설치", "files/프롬프트_설치_두도구.md",
         "34·36장. 강의에서 하는 순서 그대로입니다 — 설치 → 확인 → 시운전, 그리고 두 번째 도구는 설치와 확인을 한 번에. 막혔을 때 에러를 돌려주는 한 줄까지.", "ready"),
    ...
    ("7편", "공정 입구 · 선택과 브리프 · 39~43장", [
        ("실습 프롬프트 — 브리프 한 장 만들기", "files/프롬프트_브리프_한장.md",
         "42장. 재료는 전부 내 폴더 안에 있습니다 — 23장에서 내려받은 첨부와 프로필 카드. 인터넷이 안 돼도 됩니다.", "ready"),
